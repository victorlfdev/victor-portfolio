  ...
  pt: {
    ...
    skills: {
      ...
      grid: [
        ...
        { label: "Next.js", context: "App Router, API routes, ISR", tier: "core" },
        { label: "TypeScript", context: "Tipagem forte, generics, utility types", tier: "core" },
        { label: "Node.js", context: "Express, API REST, middleware", tier: "extended" },
        { label: "PostgreSQL", context: "Prisma ORM, migrações", tier: "extended" },
        { label: "Tailwind CSS", context: "Design tokens, dark mode", tier: "core" },
        { label: "HTML5 / CSS3", context: "Semântico, acessível, animações", tier: "core" },
        { label: "JavaScript", context: "ES6+, async/await, APIs", tier: "core" },
        { label: "UX & Design", context: "Figma, design systems", tier: "extended" },
        { label: "Git / GitHub", context: "Branching, PR, CI/CD básico", tier: "core" },
        { label: "Responsive Design", context: "Mobile-first, fluid layouts", tier: "core" },
        { label: "Bootstrap 5", context: "Grid, componentes, customização", tier: "familiar" },
      ],
      tier: {
        core: "Núcleo",
        extended: "Expandido",
  ...
  en: {
    ...
    skills: {
      ...
      grid: [
        ...
        { label: "Next.js", context: "App Router, API routes, ISR", tier: "core" },
        { label: "TypeScript", context: "Strong typing, generics, utility types", tier: "core" },
        { label: "Node.js", context: "Express, REST API, middleware", tier: "extended" },
        { label: "PostgreSQL", context: "Prisma ORM, migrations", tier: "extended" },
        { label: "Tailwind CSS", context: "Design tokens, dark mode", tier: "core" },
        { label: "HTML5 / CSS3", context: "Semantic, accessible, animations", tier: "core" },
        { label: "JavaScript", context: "ES6+, async/await, APIs", tier: "core" },
        { label: "UX & Design", context: "Figma, design systems", tier: "extended" },
        { label: "Git / GitHub", context: "Branching, PR, CI/CD basics", tier: "core" },
        { label: "Responsive Design", context: "Mobile-first, fluid layouts", tier: "core" },
        { label: "Bootstrap 5", context: "Grid, components, customisation", tier: "familiar" },
      ],
      tier: {
        core: "Core",
        extended: "Extended",
